...
<p><em>(Analyse du sujet — partie précédente)</em></p>

<h3>Ouverture vers la problématisation</h3>
<p><em>(mise en relief des problèmes engendrés par la question)</em></p>
...
<h3>Retour à l'analyse du sujet → problématisation</h3>
...
<p>⇒ annonce des perspectives selon lesquelles la question sera abordée.</p>
...
<aside class="ann-manu">mini intro de partie</aside>
...
<div class="callout def">
  ...
  <p>Position philosophique selon laquelle la <strong>VÉRITÉ</strong> (= l'adéquation entre la pensée / le langage et la réalité) est inatteignable.</p>
</div>

<aside class="ann-manu">la vérité concerne ce qu'on pense ou dit !</aside>

<p><strong>ARGUMENTS DU SCEPTICISME :</strong></p>

<h4>Les sens sont trompeurs</h4>
...
<p><em>[Distinction objectif/subjectif]</em></p>

<p>Exemples d'illusion sensible : les couleurs, le mouvement du soleil, l'immobilité de la Terre, etc.</p>

<div class="callout def">
  <div class="callout-title">Sensibilité</div>
  <p>Faculté du corps animal d'éprouver des sensations visuelles, acoustiques, tactiles, etc. (Adjectif : sensible).</p>
</div>

<h4>La raison n'est pas non plus infaillible</h4>

<div class="callout def">
  <div class="callout-title">Raison</div>
  <p>La <strong>RAISON</strong> est la faculté de l'esprit humain lui permettant de penser de manière logique, méthodique et cohérente afin de distinguer le vrai du faux, le bien du mal, etc.</p>
</div>
...
<div class="callout warn">
  <div class="callout-title">Solution sceptique</div>
  <p>Douter de tout et ne rien tenir pour vrai.</p>
</div>
`
};

window.SEQUENCE_1.content += `
<h4>b) La méthode cartésienne : le doute méthodique et hyperbolique</h4>

<p><em>[Manuel, p. 143-145, Textes 9 à 11]</em></p>

<div class="callout note">
  <div class="callout-title">Méthodique / Hyperbolique</div>
  <p><strong>Méthodique</strong> : qui sert de méthode ❖ <strong>Hyperbolique</strong> : qui est volontairement exagéré</p>
</div>
...
<aside class="ann-manu">arguments des sceptiques pour (1) et (2) ; doute hyperbolique / volontairement exagéré pour (3) et (4)</aside>

<ol>
  <li><strong>Le problème des sens</strong> : Descartes constate d'abord que <strong>les sens sont parfois trompeurs</strong>. Alors, par prudence, il décide de ne plus faire confiance aux données de la perception.</li>
  <li><strong>L'hypothèse du rêve</strong> : Toujours dans cette idée que nos sens sont trompeurs, DESCARTES évoque l'impossibilité de distinguer le rêve de la réalité. En effet, combien de fois il nous était arrivé d'être sûr que ce que nous vivions était réel, alors qu'en fait on rêvait ? Pouvons-nous être certains que nous ne rêvons pas en ce moment ?</li>
  <li><strong>L'hypothèse du Dieu trompeur</strong> : Néanmoins, même ainsi, on ne peut pas douter des vérités qui ne viennent pas des sens, comme les vérités mathématiques : peu importe si nous rêvons ou si nous sommes réveillés, 2 + 3 = 5. Sauf que le scepticisme conteste aussi les vérités de la raison (ce sont les vérités mathématiques ou logiques). Alors, DESCARTES radicalise son doute en introduisant, troisièmement, l'hypothèse du <strong>Dieu trompeur</strong> : Dieu nous a créés de telle façon que nous nous trompons à chaque fois quand nous additionnons 2 et 3.</li>
  <li><strong>L'hypothèse du malin génie</strong> : En dernière étape, DESCARTES rend son doute complètement hyperbolique, c'est-à-dire exagéré, par la <strong>fiction du malin génie</strong> : DESCARTES imagine un esprit très puissant et très trompeur qui l'abuse continuellement <strong>en lui faisant croire</strong> qu'il a un corps et qu'il perçoit des arbres, des pierres, des animaux, des hommes, alors que rien n'existe. Dans l'expérience <em>imaginaire</em> de DESCARTES, le malin génie crée continuellement l'illusion de l'existence des choses, alors que rien n'existe.</li>
</ol>

<h4>c) Le <em>cogito</em> (« je pense ») : la certitude indubitable</h4>

<p><em>[Manuel, p. 145, Texte 12]</em></p>
...
<div class="author-card">
  ...
  <div>
    ...
    <div class="ac-meta">1724 – 1804 · Allemagne · <em>Anthropologie du point de vue pragmatique</em> (1798), §1</div>
  </div>
</div>
...
<blockquote>
  ...
  <cite>Kant, Anthropologie du point de vue pragmatique</cite>
</blockquote>
...
<div class="hl-red">
  <p>Certes, la capacité de se représenter comme un « je » différent de tous les autres êtres vivants ou autres personnes, est manifestement une caractéristique éminemment et exclusivement humaine. En effet nous n'avons pas assez de preuves pour penser que les animaux se font une représentation de leur propre intériorité. Par contre Kant se sert de ce constat pour justifier son anthropocentrisme, c'est-à-dire une vision du monde dans laquelle l'homme apparaît comme l'être le plus important.</p>
</div>

<div class="hl-green">
  <p>Or, il ne va pas de soi que la conscience réfléchie soit une faculté qui assure une supériorité infinie à l'être qui la possède. Kant fait de la conscience réfléchie une faculté tellement annoblissante qu'il affirme qu'elle nous donne une telle supériorité que nous pouvons disposer à notre guise des animaux : on peut les manger, on peut les utiliser pour des expériences, on peut les disséquer vivants, on peut les enfermer dans les cirques.</p>
</div>
...
<div class="callout warn">
  <div class="callout-title">Transition (conclusion + objection)</div>
