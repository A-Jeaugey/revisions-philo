// Séquence 6 — A-t-on le devoir d'être heureux ?
window.SEQUENCE_6 = {
  id: 6,
  number: "VI",
  slug: "devoir-bonheur",
  title: "A-t-on le devoir d'être heureux ?",
  short: "De Calliclès à Spinoza : qu'est-ce qu'une vie réussie ?",
  perspectives: [],
  ...
  inProgress: true,
  plan: [
    { t: "Une morale qui vise le bonheur est possible", sub: ["Le bonheur ne peut pas consister dans le hédonisme radical","Ainsi le bonheur est indissociable du bien moral"] }
  ],
  content: `
<div class="callout warn">
  <div class="callout-title">Fiche en cours</div>
  <p>Séquence non terminée en classe — transcription jusqu'au point d'arrêt actuel.</p>
</div>

<h2 id="intro">Intro : mettre en lumière les problèmes</h2>
...
<p><strong>2. Bonheur :</strong> étymologie → bon + heur → chance</p>
...
<h3 id="hedonisme">1. Le bonheur ne peut pas consister dans le hédonisme radical</h3>
...
<ul>
  <li>Trop de plaisir engendre l'ennui, la lassitude.<br>↳ Pour profiter d'un plaisir, il faut une certaine modération.</li>
...
<h3 id="bien-moral">2. Ainsi le bonheur est indissociable du bien moral</h3>
...
<div class="callout warn">
  <div class="callout-title">Arrêt de la transcription ici</div>
  <p>Séquence à compléter.</p>
</div>
`
};
